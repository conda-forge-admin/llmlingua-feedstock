...
Summary: To speed up LLMs inference and enhance LLMs perceive of key information, compress the prompt and KV-Cache, which achieves up to 20x compression with minimal performance loss.
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/llmlingua-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/llmlingua-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `llmlingua` available on your platform:
...
```
pixi search llmlingua --channel conda-forge
```
